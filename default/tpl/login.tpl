...
<body>
	<noscript><div class="syserror_common">Внимание! В вашем браузере отключен <b>JavaScript</b>.<div class="info">Для полноценной работы с админ. панелью <b>включите его</b>.</div></div></noscript>
