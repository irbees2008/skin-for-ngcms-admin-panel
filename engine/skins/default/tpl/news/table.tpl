...
<dd>
    ...
    <input type="submit" value="{{ lang.editnews['do_show'] }}" class="fr filterbutton"  />
</dd>
</dl>
</form>
</div>
...
<th class="mobile-hide-480">{{ lang.editnews['postid_short'] }}</th>
...
<tr>
	...
	<td class="mobile-hide-480">{% if (entry.state == 1) %}<i class="fa fa-check" title="{{ lang['state.published'] }}"></i>{% elseif (entry.state == 0) %}<i class="fa fa-times" title="{{ lang['state.unpiblished'] }}"></i>{% else %}<i class="fa fa-pencil" title="{{ lang['state.draft'] }}"></i>{% endif %} </td>
...
<dl class="fl">
<dt>
<label for="rpp" class="">{{ lang.editnews['action'] }}</label>
</dt>
<dd>

<select name="subaction" id="subaction" class="fl">
...
<input type="submit" value="{{ lang.editnews['submit'] }}" class="button fr" />
</dd>
</dl>
{% endif %}
