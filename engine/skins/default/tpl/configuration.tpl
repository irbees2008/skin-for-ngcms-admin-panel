...
<form method="post" action="{{ php_self }}">
	...
	<div class="content clear" id="userTabs">
		...
		<div class="content-nav clear">
			<input class="navbutton active" type="button" onclick="ChangeOption('userTabs-db');" value="{{ lang['db'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-security');" value="{{ lang['security'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-system');" value="{{ lang['syst'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-news');" value="{{ lang['sn'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-users');" value="{{ lang['users'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-imgfiles');" value="{{ lang['files'] }}/{{ lang['img'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-auth');" value="{{ lang['auth'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-cache');" value="{{ lang['cache'] }}" />
			<input class="navbutton" type="button" onclick="ChangeOption('userTabs-multi');" value="{{ lang['multi'] }}" />
		</div>
		
		<!-- ########################## DB TAB ########################## -->
		<div class="navtab" id="userTabs-db">
			<!-- TABLE DB//Connection -->
			<table>
			<tr>
		...
		<!-- ########################## SECURITY TAB ########################## -->
		<div class="navtab" id="userTabs-security">
			<table>
			<tr>
		...
		<!-- ########################## SYSTEM TAB ########################## -->
		<div class="navtab" id="userTabs-system">
			<table>
			<tr>
		...
		<!-- ########################## NEWS TAB ########################## -->
		<div class="navtab" id="userTabs-news">
			<table>
			<tr>
		...
		<!-- ########################## USERS TAB ########################## -->
		<div class="navtab" id="userTabs-users">
			<table>
			<tr>
