...
<div class="content-box">
		<h3 class="content-title">Настройки админ панели</h3>
	<ul>
		<li>
...
<div class="content-box">
	<h3 class="content-title">{{ lang.options['news'] }}</h3>
	<ul>
		<li>
...
<div class="content-box">
	<h3 class="content-title">{{ lang.options['system'] }}</h3>
	<ul>
		<li>
...
<div class="content-box">
	<h3 class="content-title">{{ lang.options['userman'] }}</h3>
	<ul>
		<li>
...
<div class="content-box">
	<h3 class="content-title">{{ lang.options['other'] }}</h3>
	<ul>
		<li>
